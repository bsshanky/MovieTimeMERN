...
function App() {
  ...
  const retrieveFavorites = useCallback(() => {
    ...
    const addFavorite = (movieId, title, poster) => {
      setDoSaveFaves(true);
      setFavorites([...favorites, {movieId, title, poster}]) 
    }
    ...
    const reorderFavorites = (dragIndex, hoverIndex) => {
        setDoSaveFaves(true);
    ...
    <GoogleOAuthProvider clientId={clientId}>
      <div className="App">
        ...
        <Routes>
          ...
          {user && (<Route exact path="/favorites" element={
